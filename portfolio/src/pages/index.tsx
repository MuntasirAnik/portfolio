  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full dark:text-light">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/dummy.pdf"
                  target="_blank"
                  className="flex items-center bg-black text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark
        ...
        <HireMe />
        {/* <div className="absolute right-8 bottom-8 lg:bottom-44 inline-block w-16 md:hidden">
